                    ...
                    <nav className="relative z-50 flex justify-between">
                        <div className="flex items-center md:gap-x-12">
                            ...
                            <div className="hidden md:flex md:gap-x-6">
                                { navigation.map((item) => (
                                    <a key={item.name} href={item.href} className="inline-block rounded-lg px-2 py-1 text-base text-slate-700 hover:bg-slate-100 hover:text-slate-900">{item.name}</a>
                                ))}
                            </div>
                        </div>
                        <div className="flex items-center gap-x-5 md:gap-x-8">
                            <div className="hidden md:block">
                                <a href="/login" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900">Sign in</a>
                            </div>
                            <a href="/register" className="group inline-flex items-center rounded-full py-2 px-4 text-sm font-semibold bg-blue-600 text-white">
                                <span>Get started Today</span>
                            </a>
                            <div className="-mr-1 md:hidden">
                                <div data-headlessui-state>
                                    <button className="relative z-10 flex h-8 w-8 items-center justify-center ui-not-focus-visible:outline-none" aria-label="Toggle Navigation" type="button" aria-expanded="false" data-headlessui-state id="headlessui-popover-button-:Rbplla:">
                                ...
                                <div className="fixed top-1 left-1 w-1 h-0 p-0 m-1 overflow-hidden whitespace-nowrap border-0 none"></div>
                            </div>
                        </div>
                    </nav>
                </div>
