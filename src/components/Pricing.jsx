        ...
        <>
            <section id="pricing" className="bg-slate-900 py-20 sm:py-32">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:mx-8 lg:max-w-none lg:grid-cols-3 xl:gap-x-8">
                        <section className="flex flex-col rounded-3xl px-6 sm:px-8 lg:py-8">
                            ...
                            <p className="mt-2 text-base text-slate-400">Good for anyone who is self-employed and just getting started.</p>
                            ...
                            <a href="#" className="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none ring-slate-700 text-white hover:ring-slate-500 active:ring-slate-700 active:text-slate-400 focus-visible:outline-white mt-8">Get started</a>
                        </section>
                        ...
                        <h3 className="mt-5 font-display text-lg text-white">Small business</h3>
                            <p className="mt-2 text-base text-white">Perfect for small / medium sized business.</p>
                            ...
                            <a href="#" className="group inline-flex ring-1 items-center justify-center rounded-full py-2 px-4 text-sm focus:outline-none bg-white text-slate-900 hover:bg-blue-50 active:bg-blue-200 active:text-slate-600 focus-visible:outline-white mt-8">Get started</a>
                        </section>
                        <section className="flex flex-col rounded-3xl px-6 sm:px-8 lg:py-8">
