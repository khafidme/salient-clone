        ...
        <>
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32">
                ...
                <div className="mt-10 flex justify-center gap-x-6">
                    <a href="#pricing" className="font-bold text-white bg-slate-900 px-5 py-3 rounded-full">Get 6 months free</a>
                    <a href="#" className="font-bold border px-5 py-3 rounded-full inline-flex items-center justify-center">
                        ...
                        <span className="ml-3 text-gray-600 font-normal">Watch Video</span>
                    </a>
                </div>
                    ...
                    <ul role="list" className="mt-8 flex items-center justify-center gap-x-8 sm:flex-col sm:gap-x-0 sm:gap-y-10 xl:flex-row xl:gap-x-12 xl:gap-y-0">
                        <li>
                            <ul role="list" className="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                                <li><img src="/src/assets/transistor.7274e6c3.svg" alt="" /></li>
                                <li><img src="/src/assets/tuple.74eb0ae0.svg" alt="" /></li>
                                <li><img src="/src/assets/statickit.d7937794.svg" alt="" /></li>
                            </ul>
                        </li>
                        <li>
                            <ul role="list" className="flex flex-col items-center gap-y-8 sm:flex-row sm:gap-x-12 sm:gap-y-0">
                                <li><img src="/src/assets/mirage.18d2ec4e.svg" alt="" /></li>
                                <li><img src="/src/assets/laravel.7deed17e.svg" alt="" /></li>
                                <li><img src="/src/assets/statamic.6da5ebfb.svg" alt="" /></li>
                            </ul>
                        </li>
                    </ul>
                </div>
