                ...
                <div className="py-6">
                    ...
                    <nav className="mt-10 text-sm" aria-label="quick links">
                        <div className="-my-1 flex justify-center gap-x-6">
                            <a href="#features" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900">Features</a>
                            <a href="#testimonials" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900">Testimonials</a>
                            <a href="#pricing" className="inline-block rounded-lg px-2 py-1 text-sm text-slate-700 hover:bg-slate-100 hover:text-slate-900">Pricing</a>
                        </div>
                    </nav>
                </div>
                <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
                    <div className="flex gap-x-6">
                        <a href="#" aria-label="Taxpal on twitter" className="group">
                        ...
                        <a href="#" aria-label="Taxpal on Github" className="group">
                            <svg aria-hidden="true" className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700">
                    ...
                    <p className="mt-6 text-sm text-slate-500 sm:mt-0">Copyright &copy; 2023 Taxpal. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
